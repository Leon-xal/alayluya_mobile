...
import '../pages/test_until/test_onesignal.dart';
...
class Router {
  static final _routes = {
    ...
    '/index': (BuildContext context, { Object args }) => IndexPage(arguments: args),
    '/home': (BuildContext context, { Object args }) => IndexPage(arguments: args),
    '/today': (BuildContext context, { Object args }) => IndexPage(arguments: args),
    '/article': (BuildContext context, { Object args }) => IndexPage(arguments: args),
    '/membercenter': (BuildContext context, { Object args }) => IndexPage(arguments: args),
    '/eland_prayers': (BuildContext context, { Object args }) => ElandPrayersListPage(args: args,),
    '/article_like': (BuildContext context, { Object args }) => ArticleLikePage(),
    '/article_list': (BuildContext context, { Object args }) => ArticleListPage(args: args,),
    '/article_report': (BuildContext context, { Object args }) => ArticleReport(args: args,),
    '/my_eland_list': (BuildContext context, { Object args }) => MyElandList(args: args,),
    '/eland_list': (BuildContext context, { Object args }) => ElandList(args: args,),
    '/eland_info': (BuildContext context, { Object args }) => ElandInfo(args: args,),
    ...
    '/bind_info': (BuildContext context, { Object args }) => BindEmailOrPhone(type:args),

    '/forgot_password': (BuildContext context, { Object args }) => ForgotPassword(args: args,),
    '/setting': (BuildContext context, { Object args }) => SettingPage(),
    '/search': (BuildContext context, { Object args }) => SearchPage(),
    '/search_result': (BuildContext context, { Object args }) => SearchResult(args: args,),
    '/article_detail': (BuildContext context, { Object args }) => ArticleDetail(args: args,),
    '/terms_of_use': (BuildContext context, { Object args }) => TermsOfUse(),
    '/prayers_detail': (BuildContext context, { Object args }) => PrayersDetail(args: args,),
    '/comment_page': (BuildContext context, { Object args }) => CommentPage(args: args,),
    '/reply_comment': (BuildContext context, { Object args }) => ReplyComment(args: args,),
    ...
    '/test_facebook_login': (BuildContext context, { Object args }) => TestFacebookLogin(),
...
//    '/menu': (BuildContext context, { Object args }) => Toolbar(arguments: args,),
    '/test_modeler': (BuildContext context, { Object args }) => TestModeler(args: args),
