...
import '../../model/article_like_list_model/data.dart';
...
//      print('aaa===>${widget.isShowcenterload}');
      _loadListData(context,isshowloading:widget.isShowCenterload,limit:widget.pagelimit,pageid:page_id,cateid:widget.cateid,search_by_title:widget.search_by_title,user_id:widget.user_id);
    });
  }
...
//     await Future.delayed(Duration(milliseconds: 1000));
    Future.delayed(Duration.zero,()async{
      if(mounted) {
        ...
        articleItems = [];
        articleTagsItems = [];
       await  _loadListData(context,isshowloading:false,limit:widget.pagelimit,pageid:page_id,cateid:widget.cateid,search_by_title:widget.search_by_title,user_id:widget.user_id);
      }
...
//     await Future.delayed(Duration(milliseconds: 1000));
    Future.delayed(Duration.zero,(){
      if(mounted) {
        _loadListData(context,isshowloading:false,limit:widget.pagelimit,pageid:++page_id,cateid:widget.cateid,search_by_title:widget.search_by_title,user_id:widget.user_id);
      }
