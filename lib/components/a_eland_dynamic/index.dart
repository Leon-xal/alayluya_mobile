...
//     await Future.delayed(Duration(milliseconds: 1000));
    ...
    if(mounted) {
      ...
      elandTagsItems = [];
//      print('onRefresh2===>');
      await _loadListData(context,isshowloading:false,limit:widget.pagelimit,pageid:page_id,userid:widget.uid);
    }
  ...
  void _onLoading() async{
    ...
    if(mounted) {
      ...
      _loadListData(context,isshowloading:false,limit:widget.pagelimit,pageid:page_id2,userid:widget.uid);
    }
