...
//      print('aaa===>${widget.isShowcenterload}');
      _loadListData(context,isshowloading:widget.isShowCenterload,limit:widget.pagelimit,pageid:page_id,cateid:widget.cateid,search_by_title:widget.search_by_title,user_id:widget.user_id,eland_id:widget.eland_id);
    });
  }
                ...
                new Expanded(
                    ...
                    child: new Column(
                      ...
                      children: <Widget>[
                        ...
                        // Text('${item.desc}'),
                        (widget.isShowDesc == true && item.desc != '')? Container(
                          child: new Text(
                            item.desc,
                            maxLines:2,
                            overflow:TextOverflow.ellipsis,
...
//      print('onloading2===>${page_id}');
  ...
  _loadListData(BuildContext context, {bool isshowloading=true, int pageid=1, int limit=5,cateid=0,search_by_title='',user_id=0,eland_id=0}) async {
...
//    print('articlereault====>${search_by_title}');
    try {
      ...
      Map result = res.data;
      // print('result===>${result}');
      ElandPrayersListModel tempArticleLikeList = ElandPrayersListModel.fromJson(result);
      if (mounted) {
        setState(() {
