...
class _SetDomainState extends State<SetDomain> {
  ...
  _submit() async {
    ...
    if ((serveraddressController.text.trim() == '') && isTextInput == true) {
      return G.toast('Please enter the Server address');
    }
    if ((domain == '') && isTextInput == false) {
                            ...
                            (isTextInput == true)
                                ...
                                : DropdownButton(
                                    ...
                                    items: [
                                      ...
                                      if (domain !=
                                              'http://testapi2.alayluya.com' &&
                                          domain !=
                                              'https://api11.alayluya.info' &&
                                          domain != '')
                                        DropdownMenuItem(
                                          child: Text('Cur：${domain}'),
                                          value: '${domain}',
                                        ),
                                      DropdownMenuItem(
                                        child: Text(
                                        ...
                                        value: 'http://testapi2.alayluya.com',
                                      ),
                                      DropdownMenuItem(
                                        child: Text(
                                          'https://testapi2.alayluya.com',
                                        ),
                                        value: 'https://testapi2.alayluya.com',
                                      ),
                                      DropdownMenuItem(
                                        child: Text(
                                          'https://api1.alayluya.info',
                                        ),
                                        value: 'https://api1.alayluya.info',
                                      ),
                                      DropdownMenuItem(
                                        child: Text(
                                          'https://api11.alayluya.info',
                                        ),
                                        value: 'https://api11.alayluya.info',
                                      ),
                                      DropdownMenuItem(
                                        child: Text('Other...'),
                                        value: 'other',
