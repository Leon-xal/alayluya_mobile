              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  child: TextField(
                    ...
                    controller: TextEditingController.fromValue(
                      TextEditingValue(
                        text: (firstname['value'] == null || firstname['value'] == '')?'':firstname['value'],

                        selection: TextSelection.fromPosition(
                            TextPosition(
                              affinity: TextAffinity.downstream,
                              offset: (firstname['value'] == null || firstname['value'] == '')?0:firstname['value'].length,
                            )
                        ),
                      ),
                    ),
                ...
                Container(
                  ...
                  child: TextField(
                    ...
                    controller: TextEditingController.fromValue(
                      TextEditingValue(
                        text: (lastname['value'] == null || lastname['value'] == '')?'':lastname['value'],

                        selection: TextSelection.fromPosition(
                            TextPosition(
                              affinity: TextAffinity.downstream,
                              offset: (lastname['value'] == null || lastname['value'] == '')?0:lastname['value'].length,
                            )
                        ),
                      ),
                    ),
                ...
                Container(
                  ...
                  child: TextField(
                    ...
                    controller: TextEditingController.fromValue(
                      TextEditingValue(
                        text: (nickname['value'] == null || nickname['value'] == '')?'':nickname['value'],
                        selection: TextSelection.fromPosition(
                            TextPosition(
                              affinity: TextAffinity.downstream,
                              offset: (nickname['value'] == null || nickname['value'] == '')?0:nickname['value'].length,
                            )
                        ),
                      ),
                    ),
...
//                    email['verify'] = regExp.hasMatch(e);
                        nickname['value'] = e;
                        nickname['verify'] = (e == null || e == '')?false:true;
                      });
                    },
                  ),
                ),
