...
//                  width: 50.0,
                ...
                new Expanded(
                    child: new Container(
                      child: new Text(_showresult,style: new TextStyle(color: Colors.black)),
                    )
                ),
                new Container(
                  child: new FlatButton(
            ...
            children: <Widget>[
              ...
              (userid > 0)?AArticleList(
                ...
                topchild: Container(
                  ...
                  decoration: BoxDecoration(
                    border: new Border(bottom: BorderSide(width: 2.0, color: hex('#cacbd1'))),
                  ),
                  padding: const EdgeInsets.only(top:10.0,bottom:10),
                  margin: const EdgeInsets.only(left: 10.0,right:10.0,top:10.0,bottom:10,),
                ...
                bottomchild: Container(
                  ...
                  child: AButton.normal(
                      ...
                      onPressed: (){
                        G.pushNamed('/article',arguments: {'search_key': _result});
                      }
                  ),
                ),
              ):Container(),
              ...
              (userid > 0)?AElandList(
                ...
                topchild: Container(
                  ...
                  child: Text("Eland", style: new TextStyle(color: Colors.black,fontWeight: FontWeight.bold, fontSize: 16.0,)),
                ),
                bottomchild: Container(
                  margin: EdgeInsets.only(top:10,bottom:10,left: 10,right: 10),
                  child: AButton.normal(
                      ...
                      borderRadius: BorderRadius.circular(5),
                      onPressed: (){
                        G.pushNamed('/eland_list',arguments: {'search_key': _result});
                      }
                  ),
                ),
              ):Container(),
