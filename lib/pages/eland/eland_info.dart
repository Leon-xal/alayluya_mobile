...
import '../../components/a_google_map/index.dart';
...
class _ElandInfoState extends State<ElandInfo> {
  ...
  _loadElandData({int elandid=0,int uid = 0}) async {
    try {
      var res = await G.req.eland.detail(
        userid: uid,
        eland_id: elandid,
      );
      if(res.data != null){
...
//        headers: <String, String>{'my_header_key': 'my_header_value'},
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: (eland == null)? _buildProgressIndicator() : Stack(
        children: <Widget>[
    ...
    //                  (eland.name == '')?Text(''):Text(eland.name),
                  ...
                  Container(
                    ...
                    child: new Row(
                      ...
                      children: <Widget>[
                          ...
                          children: <Widget>[
                            ...
                            new Container(
                              ...
                              child: new Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: <Widget>[
                                  new Text(eland.name, style: new TextStyle(color: Colors.black,fontWeight: FontWeight.bold, fontSize: 16.0,)),
                                  new Text(eland.type, style: new TextStyle(color: Colors.black54)),
                                ],
                              ),
                            ),
                        ...
                        new Column(
                          children: <Widget>[
                            new Text(eland.follow.toString(), style: new TextStyle(color: Colors.black,fontWeight: FontWeight.bold, fontSize: 16.0,)),
                            new Text('用戶關注', style: new TextStyle(color: Colors.black54, fontSize: 13.0)),
                            Container(
                              margin: const EdgeInsets.only(top: 5.0),
                              child: (eland.ifollow == true && eland.follow > 0)?
                              AButton.icon(
                                  width: 70,height: 25,borderColor: rgba(28, 141, 160, 1),bgColor: rgba(28, 141, 160, 1),plain: true,
                                  textChild: Text('已關注', style: TextStyle(
                                      color: hex('#fff'),
                                      fontSize: 13
                                  ),),
                                  ...
                                  textChild: Text('關注', style: TextStyle(
                                      color: hex('#333'),
                                      fontSize: 13
                                  ),),
                                  borderRadius: BorderRadius.circular(40),
                  ...
                  Container(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: <Widget>[
                        new Text("分享", style: new TextStyle(color: Colors.black,fontWeight: FontWeight.bold, fontSize: 16.0,)),
                        Container(
                          ...
                          child: new Row(
                            ...
                            children: <Widget>[
                              new InkWell(
                                  ...
                                  onTap: () async {
                                    print('eland.MobileAppViewUrl=======>${eland.MobileAppViewUrl}');
                                    ...
                                    var response = FlutterShareMe().shareToFacebook(
                                        url: '${eland.MobileAppViewUrl}', msg: '${eland.desc}');
                              ...
                              new InkWell(
                                  ...
                                  onTap: () async {
                                    if (Platform.isAndroid) {
                                      String response = await FlutterShareMe().shareToWhatsApp(msg: eland.MobileAppViewUrl);
                                      if (response == 'false' || response == false) {
                                        await G.toast('請安裝WhatsApp');
                                      }
                                    } else {
                                      String share_url2 = Uri.encodeComponent(eland.MobileAppViewUrl);
                                      try{
                              ...
                              new InkWell(
                                  ...
                                  onTap: () {
                                    String share_text2 = Uri.encodeComponent(eland.desc);
                                    String share_url2 = Uri.encodeComponent(eland.MobileAppViewUrl);
                                    try{
                              ...
                              new InkWell(
                                  ...
                                  onTap: () async {
                                    print('content_app_link====>${eland.MobileAppViewUrl}');
                                    Clipboard.setData(ClipboardData(text: eland.MobileAppViewUrl,));
                                    await G.toast('已復制連結');
                                  }
                              ),
                            ],
                  ...
                  Container(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: <Widget>[
                        new Text("簡介", style: new TextStyle(color: Colors.black,fontWeight: FontWeight.bold, fontSize: 16.0,)),
                        new Text(eland.desc, style: new TextStyle(color: Colors.black,fontWeight: FontWeight.normal, fontSize: 16.0,)),
                      ],
                    ),
                  ),
                  ...
                  Container(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: <Widget>[
                        new Text("相冊", style: new TextStyle(color: Colors.black,fontWeight: FontWeight.bold, fontSize: 16.0,)),
                        Container(
                          alignment: Alignment.topLeft,
    //                      padding: const EdgeInsets.only(left: 0.0,right:0.0,bottom:10.0),
                          child: InkWell(
                            ...
                            child: new Text(eland.album_url, style: new TextStyle(color: rgba(28, 141, 160, 1),fontWeight: FontWeight.normal, fontSize: 16.0,)),
                          ),
    ...
    //                      ),
                  ...
                  Container(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: <Widget>[
                        new Text("本周刊物", style: new TextStyle(color: Colors.black,fontWeight: FontWeight.bold, fontSize: 16.0,)),
                        Container(
                          alignment: Alignment.topLeft,
                          child: new SingleChildScrollView(
                            scrollDirection: Axis.horizontal,
                              ...
                              children: eland.brochure.map((item){
                                return GestureDetector(
                                  onTap: () {
                                    if(item.type == 1){
                                      //pdf
                                      APdfview.show(context,url: item.source);
                                      print('pdf====>${item.source}');
                                    }else if(item.type == 2){
                                      //mp3
                                      AAudioView.show(context,url: item.source);
                  ...
                  Container(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: <Widget>[
                        Text("聯絡我們", style: new TextStyle(color: Colors.black,fontWeight: FontWeight.bold, fontSize: 16.0,)),
                        Text.rich(
                          new TextSpan(
                              style: new TextStyle(
                                  color: Colors.black,
    ...
    //                                print('clicklink');
                                    AWebview.open(context, url: eland.link1,title: eland.link1);
                                  },
                                ),
                                (eland.link2 == '')? new TextSpan() :
                                new TextSpan(
                                  text: "\n"+eland.link2,
                                  style: new TextStyle(
                                      color: rgba(57, 139, 161, 1),
                                  ...
                                  recognizer: TapGestureRecognizer()..onTap = () {
    //                                print('clicklink');
                                    AWebview.open(context, url: eland.link2,title: eland.link2);
                                  },
                                ),
                                (eland.link3 == '')? new TextSpan() :
                                new TextSpan(
                                  text: "\n"+eland.link3,
                                  style: new TextStyle(
                                      color: rgba(57, 139, 161, 1),
                                  ...
                                  recognizer: TapGestureRecognizer()..onTap = () {
    //                                print('clicklink');
                                    AWebview.open(context, url: eland.link3,title: eland.link3);
                                  },
                                ),
                              ]),
                        ),
    ...
    //                    ),
                  ...
                  Container(
                    ...
                    child: AArticleList(
                      ...
                      topchild: Container(
                        ...
                        child: Text("文章", style: new TextStyle(color: Colors.black,fontWeight: FontWeight.bold, fontSize: 16.0,)),
                      ),
                      pagelimit: 3,
                      isreload:true,
                      isShowDesc:true,
                      ...
                      bottomchild: Container(
                        ...
                        child: AButton.normal(
                            ...
                            onPressed: (){
                              G.pushNamed('/article_list', arguments: {'eland_id': eland_id});
                            }
                        ),
                      ),
                    ),
                  ...
                  Container(
                    ...
                    child: AElandPrayersList(
                      ...
                      topchild: Container(
                        padding: const EdgeInsets.only(left: 10.0,right:10.0,top:10.0,),
                        child: Text("祈禱", style: new TextStyle(color: Colors.black,fontWeight: FontWeight.bold, fontSize: 16.0,)),
                      ),
                      pagelimit: 3,
                      isreload:true,
                      isShowCenterload: false,
                      ...
                      bottomchild: Container(
                        ...
                        child: AButton.normal(
                            ...
                            borderRadius: BorderRadius.circular(5),
                            onPressed: (){
                              G.pushNamed('/eland_prayers', arguments: {'eland_id': eland_id});
      //                              print('點擊更多');
