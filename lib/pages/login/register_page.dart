...
class _RegisterPage extends State<RegisterPage> {
  ...
  static Map repassword = {
    "value": null,
    "verify": true
  };

  static Map phoneFirstname = {
    "value": null,
    "verify": true
  };
  static Map phoneLastname = {
    "value": null,
    "verify": true
  };
  static Map phone = {
  ...
  static Map phonePassword = {
    "value": null,
    "verify": true
  };
  static Map phoneRepassword = {
    "value": null,
    "verify": true
  };
  static Map phoneCode = {
    "value": null,
    "verify": true
  };
          ...
          child: Container(
            ...
            child: Column(
              children: <Widget>[
                ...
                ///手機號碼註冊
               if(usePhoneNumberToRegister == true) Container(
                  child: PhoneRegister(
                    phone: phone,
                    phoneCode: phoneCode,
                ...
                ///電子郵箱註冊
                if(usePhoneNumberToRegister == false) Container(
                  child: Column(
                    children: [
                      /// 输入First Name
                      Container(
                        ...
                        child: TextField(
                          ...
                          onChanged: (e) {
                            setState(() {
                              firstname['value'] = e;
                              firstname['verify'] = (e == null || e == '')?false:true;
                            });
                          },
                        ),
                      ),
                      ...
                      Container(
                        ...
                        child: TextField(
                          ...
                          onChanged: (e) {
                            setState(() {
                              lastname['value'] = e;
                              lastname['verify'] = (e == null || e == '')?false:true;
                            });
                          },
                        ),
                      ),
...
//                    email['verify'] = regExp.hasMatch(e);
                              email['value'] = e;
                              email['verify'] = (e == null || e == '')?false:true;
                            });
                          },
                        ),
                      ),
                      ...
                      Container(
                        ...
                        child: TextField(
                          ...
                          onChanged: (e) {
                            setState(() {
                              password['value'] = e;
                              password['verify'] = (e == null || e == '')?false:true;
                            });
                          },
                        ),
                      ),
                      ...
                      Container(
                        ...
                        child: TextField(
                          ...
                          onChanged: (e) {
                            setState(() {
                              repassword['value'] = e;
                              repassword['verify'] = (e == null || e == '' || e != password['value']  )?false:true;
                            });
                          },
                        ),
                      ),
                ...
                Container(
                  ...
                  child: Text.rich(
                    new TextSpan(
                        children: <TextSpan>[
                          new TextSpan(
                            text: "By Sign up you agree to Alayluya terms and condition.For more details please read out ",
                            style: new TextStyle(
