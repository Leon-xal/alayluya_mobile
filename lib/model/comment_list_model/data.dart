...
class CommentListDatum extends Object {
  ...
  CommentListDatum(this.key,this.avatar,this.comment_id,this.user_name,this.comment_content,this.comment_time,this.like_num,this.reply_num,this.user_id,);

  factory CommentListDatum.fromJson(Map<String, dynamic> srcJson) => _$CommentListDatumFromJson(srcJson);
