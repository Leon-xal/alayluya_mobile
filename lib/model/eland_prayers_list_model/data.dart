...
class ElandPrayersListModel {
  ...
  //反序列化
  factory ElandPrayersListModel.fromJson(Map<String, dynamic> json) => _$ElandPrayersListModelFromJson(json);
  //序列化
...
class ElandPrayersListDatum {
  ...
  //反序列化
  factory ElandPrayersListDatum.fromJson(Map<String, dynamic> json) => _$ElandPrayersListDatumFromJson(json);
  //序列化
