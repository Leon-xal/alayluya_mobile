...
class ElandDynamicModel {
  ...
  ElandDynamicModel({this.code, this.list, this.msg});

  //反序列化
  factory ElandDynamicModel.fromJson(Map<String, dynamic> json) =>
      _$ElandDynamicModelFromJson(json);
  //序列化
...
class ElandDynamicDatum {
  ...
  //反序列化
  factory ElandDynamicDatum.fromJson(Map<String, dynamic> json) =>
      _$ElandDynamicDatumFromJson(json);
  //序列化
...
class ElandDynamicTags {
  String? name;
  String? value;
  ElandDynamicTags({this.name, this.value});
