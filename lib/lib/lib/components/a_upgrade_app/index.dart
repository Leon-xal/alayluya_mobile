...
class AUpgradeApp {
  ...
  static Future<bool> getInstance() async {
    ...
    if (Platform.isAndroid &&
        (systemInfo['apponline_android_version'] == '--' ||
            systemInfo['apponline_android_version'] == '')) {
      return false;
    }
    if (Platform.isIOS &&
        (systemInfo['apponline_ios_version'] == '--' ||
            systemInfo['apponline_ios_version'] == '')) {
      return false;
    }
    ...
    if (Platform.isAndroid) {
      ...
      apponline_android_version = apponline_android_version.replaceAll(
        RegExp(r'[\.\+\-]'),
        '',
      );
      ...
      apponline_ios_version = apponline_ios_version.replaceAll(
        RegExp(r'[\.\+\-]'),
        '',
      );
  ...
  static Future<void> goLaunch() async {
    ...
    if (Platform.isAndroid) {
      ...
      if (dipInfo.manufacturer == 'HUAWEI' ||
