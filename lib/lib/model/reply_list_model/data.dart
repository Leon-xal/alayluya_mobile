...
class ReplyModel extends Object {
  ...
  factory ReplyModel.fromJson(Map<String, dynamic> srcJson) =>
      _$ReplyModelFromJson(srcJson);
...
class ReplyListDatum extends Object {
  ...
  factory ReplyListDatum.fromJson(Map<String, dynamic> srcJson) =>
      _$ReplyListDatumFromJson(srcJson);
