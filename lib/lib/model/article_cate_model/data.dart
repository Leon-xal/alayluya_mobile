...
class ArticleCateModel {
  ...
  ArticleCateModel({this.code, this.list, this.msg});

  //反序列化
  factory ArticleCateModel.fromJson(Map<String, dynamic> json) =>
      _$ArticleCateModelFromJson(json);
  //序列化
...
class ArticleCateDatum {
  ...
  ArticleCateDatum({this.key, this.cateid, this.catename, this.catepic});

  //反序列化
  factory ArticleCateDatum.fromJson(Map<String, dynamic> json) =>
      _$ArticleCateDatumFromJson(json);
  //序列化
...
class ArticleCatePic {
  ...
  String? type_name;
  String? type_val;
  ArticleCatePic({this.pic, this.type, this.type_name, this.type_val});
