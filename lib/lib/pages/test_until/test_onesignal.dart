...
// //class TestOnesignal extends StatelessWidget {
// //  TestOnesignal({
// //    Key key,
// //  }) : super(key: key);
// //  @override
...
//   TestOnesignal({Key key}) : super(key: key);
//   @override
//   _TestOnesignalState createState() => new _TestOnesignalState();
// }
//
...
//     await OneSignal.shared.init("3fe5ebd9-1ef5-45c8-8161-62c5ccc85152", iOSSettings: settings);
//
...
//
//     // var accepted = await OneSignal.shared.promptUserForPushNotificationPermission(fallbackToSettings: true);
...
//
//     this.setState(() {
//       _debugLabelString = "Sent notification1 with response: $response";
//     });
//   }
//
...
//
//     this.setState(() {
//       _debugLabelString = "Sent notification2 with response: $response";
//     });
//   }
//
...
//     // );
//     return new Scaffold(
//         appBar: customAppbar(context: context,title: 'TestOnesignal'),
//         body: Container(
